...
type
  TFormCadGrupo = class(TD2BridgeForm)
...
function FormCadGrupo:TFormCadGrupo;
begin
  result:= TFormCadGrupo(TFormCadGrupo.GetInstance);
end;

procedure TFormCadGrupo.StartCardData;
begin
 FStartCard:= FCrud_CardData;
end;

procedure TFormCadGrupo.StartCardSearch;
begin
 FStartCard:= FCrud_CardSearch;
end;

procedure TFormCadGrupo.BeginRender;
begin
...
procedure TFormCadGrupo.CrudDefaultSearch(ATable, AFieldWhere, ASearch,
  AFieldOrder: string);
begin
 CrudDefaultSearch(ATable, [AFieldWhere], ASearch, [], [], [AFieldOrder]);
end;

procedure TFormCadGrupo.CrudDefaultSearch(ATable: string;
...
function TFormCadGrupo.CrudOnBack: boolean;
begin
 result:= true;
end;

function TFormCadGrupo.CrudOnClose: boolean;
begin
 result:= true;
end;

function TFormCadGrupo.CrudOnDelete: boolean;
begin
 result:= true;
end;

function TFormCadGrupo.CrudOnEdit: boolean;
begin
 result:= true;
end;

function TFormCadGrupo.CrudOnInsert: boolean;
begin
 result:= true;
end;

procedure TFormCadGrupo.CrudOnOpen;
begin

end;

function TFormCadGrupo.CrudOnSave: boolean;
begin
 result:= true;
end;

procedure TFormCadGrupo.CrudOnSearch(AText: string);
begin

end;

procedure TFormCadGrupo.Crud_ButtonBackClick(Sender: TObject);
begin
 inherited;
...
procedure TFormCadGrupo.Crud_ButtonDeleteClick(Sender: TObject);
begin
 inherited;
...
procedure TFormCadGrupo.Crud_ButtonNewClick(Sender: TObject);
begin
 CrudOperation(OpInsert);
end;

procedure TFormCadGrupo.Crud_ButtonSaveClick(Sender: TObject);
begin
 inherited;
...
procedure TFormCadGrupo.Crud_ButtonSearchClick(Sender: TObject);
begin
 inherited;
...
procedure TFormCadGrupo.Crud_DoExportCardData;
begin
...
procedure TFormCadGrupo.Crud_DoExportCardSearch;
begin
...
procedure TFormCadGrupo.CrudOperation(ACrudOperation: CrudOperation);
begin
...
function TFormCadGrupo.CrudOperationPermission(ACrudOperation: CrudOperation): boolean;
begin
 result:= true;
...
procedure TFormCadGrupo.EndRender;
begin
 inherited;
...
procedure TFormCadGrupo.ExportD2Bridge;
begin
  inherited;
...
procedure TFormCadGrupo.FormCreate(Sender: TObject);
begin
...
function TFormCadGrupo.GetColSize: string;
begin
 Result:= FColSize;
end;

function TFormCadGrupo.GetCrudPermissions: TCrudPermissions;
begin
 result:= FCrudPermissions;
end;

procedure TFormCadGrupo.InitControlsD2Bridge(const PrismControl: TPrismControl);
begin
 inherited;
...
procedure TFormCadGrupo.RenderD2Bridge(const PrismControl: TPrismControl; var HTMLControl: string);
begin
 inherited;
...
procedure TFormCadGrupo.SetColSize(AValue: string);
begin
 FColSize:= AValue;
...
procedure TFormCadGrupo.SetCrudPermissions(APermissions: TCrudPermissions);
begin
 //Fix PermTotal
